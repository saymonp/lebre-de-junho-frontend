<template>
    <div class="bg-[#120A18] min-h-screen text-white">
        ...
        <section class="lg:max-w-3xl max-sm:max-w-xs mx-auto py-10 pb-20">
            <h1 class="kurale text-2xl text-[#DBC695] mb-6">Cadastrar Novo Produto</h1>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl p-4">
                    ...
                    <label
                        ...
                        <span class="text-xs text-zinc-500 group-hover:text-zinc-300 transition-colors block">
                            Clique para selecionar fotos de sua máquina
                        </span>
...
// Acesso à Store de Produtos do Pinia
 ...
 * No fluxo real, você fará um fetch de presigned URL e depois um PUT para o S3.
 * Aqui, simulamos o upload retornando um link fictício estruturado.
 */
